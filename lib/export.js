...
(function() {
  ...
  funnels = (function() {
    ...
    funnels.prototype.funnel = function(_arg) {
      var from_date, funnel_id, interval, length, limit, optional, params, required, to_date, unit, url, where, _on;
      funnel_id = _arg.funnel_id, from_date = _arg.from_date, to_date = _arg.to_date, length = _arg.length, interval = _arg.interval, unit = _arg.unit, _on = _arg._on, where = _arg.where, limit = _arg.limit;
      ...
      url = ("" + host + "/funnels?") + qs.call(this, params);
      return req({
        url: url
      });
    };
    ...
    funnels.prototype.getByName = function(options) {
      var name;
      name = options.name;
      return this.list().then((function(_this) {
        return function(list) {
          var funnel_id;
          funnel_id = _.findWhere(list, {
            name: name
          }).funnel_id;
          options.funnel_id = funnel_id;
          return _this.funnel(options);
        };
      })(this));
    };
